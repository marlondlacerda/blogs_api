<p>
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/marlondlacerda/blogs_api?color=6E40C9&style=flat-square">
  <img alt="GitHub Top Language" src="https://img.shields.io/github/languages/top/marlondlacerda/blogs_api?color=6E40C9&style=flat-square">
  <a href="https://github.com/marlondlacerda/blogs_api/commits/main">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/marlondlacerda/blogs_api?color=6E40C9&style=flat-square">
  </a>
</p>
...
Foi arquitetado e desenvolvido, uma API de um CRUD posts de blogs(com o Sequelize). Começando pela API, o desenvolvimento de alguns endpoints (seguindo os princípios do REST) que estará conectados ao seu banco de dados.

Primeiro foi criado uma tabela para os usuários que desejam se cadastrar na aplicação. Após isso, também foi criado uma tabela de Categorias para os Posts e por fim a tabela de Posts será seu foco, guardando todas as informações dos posts realizados na plataforma.
...
```bash
# Clone o repositório
  git clone git@github.com:marlondlacerda/blogs_api.git
...
#Crie um arquivo .env para configurar o ambiente de desenvolvimento
#obs: siga o exemplo de .env.example
...
<div align="center">
  ...
  [⬆ Voltar para o topo](#boas-vindas-ao-repositório-do-api-de-blogs-)
